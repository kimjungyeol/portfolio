      ...
      <div className="container-custom">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mb-8 flex justify-center">
            <a
              href="/file/김정열_프로필.docx"
              download="김정열_프로필.docx"
              className="inline-flex items-center gap-2 rounded-lg bg-blue-600 px-6 py-3 font-semibold text-white transition-all hover:bg-blue-700 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:bg-blue-500 dark:hover:bg-blue-600"
            >
              <svg
                className="h-5 w-5"
                fill="none"
